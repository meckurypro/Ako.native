// File: hooks/useReactions.ts
//
// Direct port of web's src/hooks/useReactions.ts — plain supabase-js +
// react-query. Differences: DEBUG_DISABLE_PER_CARD_QUERIES (a temporary
// diagnostic flag, off by default on web) isn't ported, and useSound comes
// from hooks/useSound.tsx, which is a silent stand-in until native has a
// sound layer.

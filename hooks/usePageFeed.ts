// File: hooks/usePageFeed.ts
//
// Verbatim from web's src/hooks/usePageFeed.ts — plain supabase-js + react-query,
// nothing platform-specific. Imports FEED_SELECT/normalizePost from ./usePosts
// exactly as web does.
//

...
//
// Full copy of web's src/types/database.ts. It's pure types plus the
// isPlainReshare/isQuote helpers, so nothing here is platform-specific.
// Keep names and shapes identical to web so query results stay
// interchangeable; when web's file changes, re-copy it.

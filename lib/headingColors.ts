// File: lib/headingColors.ts
// Copied verbatim from web's src/lib/headingColors.ts — pure data (a
// fixed light/dark color-pair table keyed by a stored string), nothing

// File: lib/projectLinks.ts
//
// Verbatim from web's src/lib/projectLinks.ts (pure functions — slug rules and
// the canonical path), except getProjectUrl, which web builds from
// window.location.origin. Native has no such origin; build a shareable URL
// with lib/webUrl.ts once a project's share sheet is ported.
//
